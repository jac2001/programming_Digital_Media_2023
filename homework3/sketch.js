...
function preload() {
  ...
  jungleWarriorSheet = loadImage("assets/jungleWarrior.png")
}
...
function setup() {
  ...
  green = new WalkingAnimation(greenSheet,80,80,300,100,9)
  jungleWarrior = new WalkingAnimation(jungleWarriorSheet,80,80,50,50,12);
...
function keyPressed() {
  ...
  //chronoAnimation.keyPressed(RIGHT_ARROW, LEFT_ARROW)
